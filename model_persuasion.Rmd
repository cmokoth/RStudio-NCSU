...
Ah, here we see our favorite words 'children', 'charity'. This is completely in line with what we saw from the simple frequenncy plots. But not everyone's distinguishing conversation marker can be children, can it? Another observation is our counts. These words all have very low counts, less than 20 for each 'distinguishing' term. What's going on here?
...
```
We're left with a confusing plot. It has two words 'u' and 'sir', claiming that the persuader used 'sir' more in a conversation then 'u' and the persuadee used it an even number of times. This is obvously meaningless, but tf-idf is a widely celebraated technique. Why did it fail?
