...
how do people use words (and how do we look at them! method wise)
Definitions!!!
Document - 
...
The data are from the MIT gitlab page. I pulled the raw data directly from the repository, just `full_d_raw` and `full_i_raw`, which are the full dialogue and information tables about each participant (respectively). The raw datasets the basics. here's where I got it/how I did it process 
...
These conversations are about 20 exchanges long of average, but we can see that most of them were *at least* that long, with a few of them going up to 30! That's a while to talk to a stranger.
...
what is usual v unusual (interesting!)
